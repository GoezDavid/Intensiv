...
// MENU-SLIDER
//visible
var MenuSliderBtns = document.querySelectorAll('.menu-slider-btn');

var _iterator = _createForOfIteratorHelper(MenuSliderBtns),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var MenuSliderBtn = _step.value;
...
var observer = new IntersectionObserver(function (observables) {
  var _iterator2 = _createForOfIteratorHelper(observables),
      _step2;
...
var _iterator3 = _createForOfIteratorHelper(ScrollTriggers),
    _step3;

try {
  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
    ScrollTrigger = _step3.value;
